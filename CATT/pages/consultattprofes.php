<?php 
    ...
    $bolprof = $_SESSION["boleta"];
    $sql = "SELECT * from sinodal where id_prof = $bolprof";
...
<body>
    ...
    <div class="info d-flex">
        <div class="container">
            <h1 class="h1 text-center pb-4 pt-5 font-weight-bold">TT en los que participas:</h1>
            
            <?php
                    while ($mostrar=mysqli_fetch_array($result)){
                        $idtt = $mostrar['id_TT'];
                        $sqlesp = "SELECT * from tt where id_TT = $idtt";
                        $resultesp = mysqli_query($conexion,$sqlesp);
                        $mostraresp=mysqli_fetch_array($resultesp);
                        ?></td>
                <h1 class="h1 text-center pb-4 pt-5 font-weight-bold"><?php echo $mostraresp['titulo'] ?></h1><!-- aqui se pone el nombre del tt -->
            <table class="table">
                ...
                <tr>
                <td><?php echo $mostraresp['id_TT']; 
                $idtt = $mostraresp['id_TT'];?></td>
                <td><?php echo $mostraresp['titulo'] ?></td>
                <td><?php echo $mostraresp['resumen'] ?></td>
                <td>
                <?php 
